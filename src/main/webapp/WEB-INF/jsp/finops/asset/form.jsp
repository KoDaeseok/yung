            ...
            <form id="asset-form">
                ...
                <table class="form-table">
                    <tbody>
                        <tr>
                            ...
                            <td colspan="3">
                                <div class="input-with-button">
                                    <input type="text" id="fundCode" name="fundCode" class="short-input" placeholder="펀드코드">
                                    <button type="button" class="btn-search"><i class="fa-solid fa-magnifying-glass"></i></button>
                                    <input type="text" id="fundName" name="fundName" class="wide-input" placeholder="펀드명" readonly>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div style="display: flex; align-items: center; gap: 5px;">
                                    <input type="text" id="targetYear" name="targetYear" style="width: 80px;" placeholder="YYYY">
                                    <span>년</span>
                                    <select id="targetQuarter" name="targetQuarter" style="width: 80px;" class="short-input">
                        ...
                        <tr>
                            <th>취득원가</th>
                            <td><input type="text" id="acquisitionCost" name="acquisitionCost" class="short-input" readonly value="0"></td>
                            <th>평가금액</th>
                            <td><input type="text" id="appraisedValue" name="appraisedValue" class="short-input" readonly value="0"></td>
                        </tr>
                    </tbody>
                </table>
                ...
                <div class="button-container" style="margin-top: 20px; margin-bottom: 10px; justify-content: space-between;">
                    ...
                    <div>
                        ...
                        <button type="button" class="btn btn-primary" id="btn_reg"><i class="fa-solid fa-check"></i> 등록</button>
                        <button type="button" class="btn btn-secondary" onclick="location.href='/finops/asset/list'"><i class="fa-solid fa-times"></i> 취소</button>
                    </div>
                </div>

                <%-- 업로드된 데이터 표시 테이블 (컬럼 그룹 및 상세 컬럼 적용) --%>
