            ...
            <table class="signup-table">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td colspan="3"><input type="text" id="user-id" name="userId" class="short-input"></td>
                    </tr>
                    <tr>
                        <th><label for="user-name"><span class="required">*</span> 이름</label></th>
                        <td><input type="text" id="user-name" name="userName" class="short-input"></td>
                        <th><label for="department"><span class="required">*</span> 소속부서</label></th>
                        <td><input type="text" id="department" name="department" class="short-input"></td>
                    </tr>
                    <tr>
                        <th><label for="password"><span class="required">*</span> 비밀번호</label></th>
                        <td><input type="password" id="password" name="password" class="short-input"></td>
                    ...
                    <tr>
                        ...
                        <td colspan="3"><input type="password" id="password-confirm" name="passwordConfirm" class="short-input"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th><label for="company-phone"><span class="required">*</span> 회사번호</label></th>
                        <td colspan="3">
                            <div class="phone-group">
                                ...
                                <span>-</span>
                                <input type="text" id="company-phone2" name="companyPhone2">
                                <span>-</span>
                                <input type="text" id="company-phone3" name="companyPhone3">
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <th><label for="fax-number">팩스번호</label></th>
                        <td colspan="3">
                            <div class="phone-group">
                                ...
                                <span>-</span>
                                <input type="text" id="fax-number2" name="faxNumber2">
                                <span>-</span>
                                <input type="text" id="fax-number3" name="faxNumber3">
                            </div>
                        </td>
                    </tr>
                </tbody>
